    ...
    >
      ...
      <div className=" font-bold flex flex-col items-center gap-3">
        <div
          ...
          onClick={() => navigate("/")}
          className="border-2 border-slate-900 rounded px-2 py-2 cursor-pointer"
        >
      ...
      <div className="flex flex-col justify-between gap-4  font-semibold">
        <div
          // style={{
          //   boxShadow:{router.pathname.includes('all-blogs') && "rgba(0, 0, 0, 0.25) 0px 54px 55px, rgba(0, 0, 0, 0.12) 0px -12px 30px, rgba(0, 0, 0, 0.12) 0px 4px 6px, rgba(0, 0, 0, 0.17) 0px 12px 13px, rgba(0, 0, 0, 0.09) 0px -3px 5px" }}
          // }}
          onClick={() => navigate("/dashboard/all-blogs")}
          className={`${
            router.pathname.includes("/all-blogs") &&
            "text-white bg-slate-500 border-l-8 border-slate-900 rounded shadow-lg"
          }  cursor-pointer px-6 py-1`}
        >
          <span>All Blogs</span>
        </div>
        <div
          onClick={() => navigate("/dashboard/add-new-blog")}
          className={`${
            router.pathname.includes("/add-new-blog") &&
            "text-white bg-slate-500 border-l-8 border-slate-900 rounded"
          }  cursor-pointer px-6 py-1`}
        >

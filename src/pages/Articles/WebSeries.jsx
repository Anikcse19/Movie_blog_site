    ...
    <Layout>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-3 my-10 mx-3 md:mx-0">
        <div id="poster-box" className="cursor-pointer relative hover:bg-black">
          {/* poster thumbnail */}
          <div onClick={()=>router(`/articles/${reversedWebSeries[0]?.id}`)} className="poster-img w-full h-[520px] block opacity-100 transition-all duration-300 ease-in overflow-hidden ">
            <img
        ...
        <div className="grid grid-cols-2 gap-3">
          <div className=" grid grid-rows-2  gap-4">
            ...
            >
              {/* poster thumbnail */}
              <div onClick={()=>router(`/articlesdetails/${reversedWebSeries[1]?.id}`)} className="poster-img w-full h-[250px]  block opacity-100 transition-all duration-300 ease-in overflow-hidden ">
                <img
                  className="w-full h-full scale-100 hover:scale-105 transition-scale duration-300 ease-in"
            ...
            >
              {/* poster thumbnail */}
              <div onClick={()=>router(`/articles/article-details/${reversedWebSeries[2]?.id}`)} className="poster-img w-full h-[250px]  block opacity-100 transition-all duration-300 ease-in overflow-hidden ">
                <img
                  className="w-full h-full scale-100 hover:scale-105 transition-scale duration-300 ease-in"
          ...
          <div className=" grid grid-rows-2 gap-3">
            ...
            >
              {/* poster thumbnail */}
              <div onClick={()=>router(`/articles/article-details/${reversedWebSeries[3]?.id}`)} className="poster-img w-full h-[250px]  block opacity-100 transition-all duration-300 ease-in overflow-hidden ">
                <img
                  className="w-full h-full scale-100 hover:scale-105 transition-scale duration-300 ease-in"
            ...
            >
              {/* poster thumbnail */}
              <div onClick={()=>router(`/articles/article-details/${reversedWebSeries[4]?.id}`)} className="poster-img w-full h-[250px]  block opacity-100 transition-all duration-300 ease-in overflow-hidden ">
                <img
                  className="w-full h-full scale-100 hover:scale-105 transition-scale duration-300 ease-in"
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 items-center gap-10  lg:px-0">
        {/* articles */}
        <div className="lg:col-span-2 grid grid-cols-2 lg:grid-cols-2 self-start gap-3 mx-2">
        ...
        <div className="w-full flex flex-col mx-auto">
          {/* adds */}
          <div className="bg-red-800 w-[95%] mx-auto h-[250px]">adds 1</div>
          ...
          {/* adds */}
          <div className="bg-red-800 w-[95%] mx-auto h-[250px]">adds 2</div>

          {/* genres */}
          <div className="my-3 w-[95%] mx-auto">

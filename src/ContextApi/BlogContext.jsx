...
export function BlogContextProvider({children}){
    ...
    return (
        <BlogContext.Provider value={{isMobileNavOpen,setIsMobileNavOpen,genres,setGenres,categories, setCategories,selectedGenreForMovie,setSelectedGenreForMovie,selectedGenreForWebSeries,setSelectedGenreForWebSeries,isDeleteModalOpen,setIsDeleteModalOpen,token,setToken,isDeleteModalOpenForCategory,setIsDeleteModalOpenForCategory,isDeleteModalOpenForGenre,setIsDeleteModalOpenForGenre,updateCategory,setUpdateCategory,allBlogDelete,setAllBlogDelete}}>
            {children}
